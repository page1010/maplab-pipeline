...
def run_pipeline(test_mode: bool = False, target_date: str = None):
    """
        Main pipeline execution.
            Phase 1 (collector) is now live.
                Phase 2-5 stubs remain until each phase is individually implemented.
    """
    logger.info("=" * 60)
